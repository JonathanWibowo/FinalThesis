// Source from: Official android website documentation
...
public class ScanActivity extends AppCompatActivity implements ZXingScannerView.ResultHandler {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Check the android version for access permission
    ...
    private void displayAlertMessage(String message, DialogInterface.OnClickListener onClickListener) {
        new AlertDialog.Builder(ScanActivity.this).setMessage(message)
                .setPositiveButton("OK", onClickListener).setPositiveButton("Cancel", null)
                .create().show();
    }
